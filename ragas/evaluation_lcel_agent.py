...
from chains.card4a_query_llm_agent import ask_rag_chain, build_rag_chain
...
questions = [
    "Quanto o cliente Levi Fogaça gastou em 5 de abril de 2023?",  # GPT3.5 está halucinando
    ...
    "Qual o total transacionado na carteira em 5 de abril de 2023?",  # Vectorstore não está retornando o documento correspondente
    "Qual o total mensal transacionado na carteira em abril de 2023?",
    ...
    "Qual o total anual transacionado no cartão de crédito em 2023?",
...
for query in questions:
  answers.append(ask_rag_chain(query, agent_executor))
